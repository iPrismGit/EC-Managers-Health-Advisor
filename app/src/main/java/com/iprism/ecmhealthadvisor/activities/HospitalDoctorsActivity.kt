...
import com.iprism.ecmhealthadvisor.adapters.CategoryDoctorsAdapter
...
import com.iprism.ecmhealthadvisor.databinding.ActivityHospitalDoctorsBinding
...
class HospitalDoctorsActivity : AppCompatActivity() {
    ...
    private lateinit var doctorsAdapter: CategoryDoctorsAdapter
    private var doctorsList = mutableListOf<Doctor>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.refreshLayout.setOnChildScrollUpCallback { _, _ ->
            binding.doctorsRv.canScrollVertically(-1)
        }
    ...
    private fun setupRecyclerView() {
        doctorsAdapter = CategoryDoctorsAdapter(this, doctorsList)
        ...
        binding.doctorsRv.apply {
            ...
            addOnScrollListener(object : RecyclerView.OnScrollListener() {
                override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                    ...
                    binding.refreshLayout.isEnabled = !binding.doctorsRv.canScrollVertically(-1)
    ...
    private fun loadDoctors() {
        ...
        hospitalViewModel.fetchHospitalDoctors(request)
    }
    ...
    private fun observeHospitalDoctorsResponse() {
        hospitalViewModel.doctorsResponse.observe(this) { result ->
            when (result) {
                is UiState.Loading -> {
                    if (currentPage == 1) {
