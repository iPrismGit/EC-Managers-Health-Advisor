...
import com.iprism.ecmhealthadvisor.databinding.ActivityLocationBinding;
...
public class LocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    String str_lat1 = "", str_lang1 = "", Statenew = "", cityname = "";
    ...
    private List<Uri> coverImagesList;
    Bundle bundle;
    private Uri imageUri;
    String tottaladdress = "", coverPhotosJson = "", hospitalCategoryId = "", selectedSpecialitiesIds = "", hospitalOpeningTime = "",
            hospitalClosingTime = "", pharmacyValue = "", homeDelivery = "", diagnosticValue = "", hospitalLocation = "", hospitalName = "",
            logoString = "", email = "", mobile = "", userId = "", hospitalDescription = "", base64CommaSeparated = "";
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            str_lang1 = String.valueOf(longitude);
...
//                        mMap.setOnCameraMoveStartedListener((GoogleMap.OnCameraMoveStartedListener) AddadressMapActivity.this);
        ...
        binding.locationLo.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public String convertUrisToBase64(List<Uri> uriList, Context context) {
        ...
        return TextUtils.join(",", base64List);
    }
    ...
    private void handleConfirmBtn() {
        binding.confirmBtn.setOnClickListener(view -> {
            if (!str_lat1.isEmpty() && !str_lang1.isEmpty()) {
                Intent resultIntent = new Intent();
                resultIntent.putExtra("address", binding.loactionText.getText().toString().trim());
                resultIntent.putExtra("lon", str_lang1);
                resultIntent.putExtra("lat", str_lat1);
                setResult(Activity.RESULT_OK, resultIntent);
                finish();
            } else {
                ToastUtils.INSTANCE.showErrorCustomToast(this, "Please Select Hospital Location!");
            }
    ...
    private String getAddress() {
        return binding.loactionText.getText().toString().trim();
    }
...
*/
        ...
        mMap.setOnCameraIdleListener(new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                latLng = midLatLng;
                str_lat1 = String.valueOf(latLng.latitude);
                str_lang1 = String.valueOf(latLng.longitude);
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (mLastKnownLocation != null) {
                                ...
                                str_lat1 = String.valueOf(mLastKnownLocation.getLatitude());
                                str_lang1 = String.valueOf(mLastKnownLocation.getLongitude());
            ...
            if ("OK".equalsIgnoreCase(jsonObject.getString("status"))) {
                ...
                if (results.length() > 0) {
                    for (int i = 0; i < results.length() && i < maxResult; i++) {
                        ...
                        binding.loactionText.setText(tottaladdress);
...
//                                    Log.d("sublocality", sublocality);
    ...
    private String convertUriToBase64Image(Uri imageUri) {
        String base64Image = "";
        if (imageUri == null) {
            return base64Image;
        }
    ...
    private String getBase64CommaSeparatedString(String[] uriStrings) {
        List<String> base64List = new ArrayList<>();
